...
var main = (function($) { var _ = {
	...
	next: function() {
		...
		// Calculate new index.
			//var i, c = _.current, l = _.slides.length;	// OLD!! 10/02/2015
			var i, c = _.current, l = active_photo;
	...
	up: function() {
		...
		// Calculate new index.
			//var i, c = _.current, l = _.slides.length, tpr = _.settings.thumbnailsPerRow;	// OLD!! 10/02/2015
			var i, c = _.current, l = active_photo, tpr = _.settings.thumbnailsPerRow;
...
function showMorePhotos(){
	var tot_photo = $("#thumbnails article").length;
	for(i = active_photo;i < (Math.min(tot_photo, active_photo*2));i++){
		$("#thumbnails article:eq("+i+")").removeClass("hide");
		$("#thumbnails article:eq("+i+") a img").attr("src", "images/thumbs/mini/"+(i+1)+"_mini.jpg");
	}
	active_photo *= 2;
}
